...
  - IMPORTANT : Focus on the sequence of events in descripting images and videos. 
...
  - imageDescription: Precise visual scene composition for AI image generation. Include character positions, expressions, lighting, color palette, props, and environment. Focus on concrete visual elements.

  - videoDescription: Camera moves, character gestures, timing, and pacing for AI video generation. Describe motion and transitions for smooth narrative momentum.
